...
- (NSString *)bb_hmacStringUsingAlg:(CCHmacAlgorithm)alg withKey:(NSString *)key {
    size_t size;
    switch (alg) {
...
- (NSData *)bb_hmacDataUsingAlg:(CCHmacAlgorithm)alg withKey:(NSData *)key {
    size_t size;
    switch (alg) {
        case kCCHmacAlgMD5: size = CC_MD5_DIGEST_LENGTH; break;
        case kCCHmacAlgSHA1: size = CC_SHA1_DIGEST_LENGTH; break;
...
- (NSString *)bb_hmacMD5StringWithKey:(NSString *)key {
    return [self bb_hmacStringUsingAlg:kCCHmacAlgMD5 withKey:key];
}

- (NSData *)bb_hmacMD5DataWithKey:(NSData *)key {
    return [self bb_hmacDataUsingAlg:kCCHmacAlgMD5 withKey:key];
}

- (NSString *)bb_hmacSHA1StringWithKey:(NSString *)key {
    return [self bb_hmacStringUsingAlg:kCCHmacAlgSHA1 withKey:key];
}

- (NSData *)bb_hmacSHA1DataWithKey:(NSData *)key {
    return [self bb_hmacDataUsingAlg:kCCHmacAlgSHA1 withKey:key];
}

- (NSString *)bb_hmacSHA224StringWithKey:(NSString *)key {
    return [self bb_hmacStringUsingAlg:kCCHmacAlgSHA224 withKey:key];
}

- (NSData *)bb_hmacSHA224DataWithKey:(NSData *)key {
    return [self bb_hmacDataUsingAlg:kCCHmacAlgSHA224 withKey:key];
}

- (NSString *)bb_hmacSHA256StringWithKey:(NSString *)key {
    return [self bb_hmacStringUsingAlg:kCCHmacAlgSHA256 withKey:key];
}

- (NSData *)bb_hmacSHA256DataWithKey:(NSData *)key {
    return [self bb_hmacDataUsingAlg:kCCHmacAlgSHA256 withKey:key];
}

- (NSString *)bb_hmacSHA384StringWithKey:(NSString *)key {
    return [self bb_hmacStringUsingAlg:kCCHmacAlgSHA384 withKey:key];
}

- (NSData *)bb_hmacSHA384DataWithKey:(NSData *)key {
    return [self bb_hmacDataUsingAlg:kCCHmacAlgSHA384 withKey:key];
}

- (NSString *)bb_hmacSHA512StringWithKey:(NSString *)key {
    return [self bb_hmacStringUsingAlg:kCCHmacAlgSHA512 withKey:key];
}

- (NSData *)bb_hmacSHA512DataWithKey:(NSData *)key {
    return [self bb_hmacDataUsingAlg:kCCHmacAlgSHA512 withKey:key];
}
...
- (NSData *)bb_aes256EncryptWithKey:(NSData *)key iv:(NSData *)iv {
...
- (NSData *)bb_aes256DecryptWithkey:(NSData *)key iv:(NSData *)iv {
    if (key.length != 16 && key.length != 24 && key.length != 32) {
        return nil;
    }
    if (iv.length != 16 && iv.length != 0) {
...
+ (NSData *)bb_dataWithHexString:(NSString *)hexStr {
...
+ (NSData *)bb_dataNamed:(NSString *)name {
