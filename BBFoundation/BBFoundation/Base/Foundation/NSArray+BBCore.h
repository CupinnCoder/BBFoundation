 ...
 */
+ (nullable NSArray *)bb_arrayWithPlistData:(NSData *)plist;
 ...
 */
+ (nullable NSArray *)bb_arrayWithPlistString:(NSString *)plist;
 ...
 */
- (nullable id)bb_objectOrNilAtIndex:(NSUInteger)index;
 ...
 */
@interface NSMutableArray (BBCore)
...
/**
 ...
 @return A new array created from the binary plist data, or nil if an error occurs.
 */
+ (nullable NSMutableArray *)bb_arrayWithPlistData:(NSData *)plist;
...
/**
 ...
 @return A new array created from the plist string, or nil if an error occurs.
 */
+ (nullable NSMutableArray *)bb_arrayWithPlistString:(NSString *)plist;
