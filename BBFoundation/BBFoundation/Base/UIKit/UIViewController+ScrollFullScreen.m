//
//  UIViewController+ScrollFullScreen.m
//  BBFoundation
//
...
#define IS_RUNNING_IOS8 ([[[UIDevice currentDevice] systemVersion] floatValue] >= 8.0)
#else
#define IS_RUNNING_IOS8 NO
#endif
...
@implementation UIViewController (ScrollFullScreen)
...
- (void)hideNavigationBar:(BOOL)animated
{
    ...
    CGFloat top = IS_RUNNING_IOS7 ? -navigationBarHeight + overwrapStatusBarHeight : -navigationBarHeight;
...
- (void)setNavigationBarOriginY:(CGFloat)y animated:(BOOL)animated
{
    ...
    CGFloat topLimit = IS_RUNNING_IOS7 ? -navigationBarHeight + overwrapStatusBarHeight : -navigationBarHeight;
