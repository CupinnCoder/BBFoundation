...
- (UIButton *)button
{
    if (!_button)
    {
        ...
        _button.titleLabel.textColor = BBSTYLEVAR(loadingTextColor);
        _button.layer.borderWidth = 1;
        _button.layer.borderColor = BBSTYLEVAR(loadingLineColor).CGColor;
        _button.size = CGSizeMake(236/2, 30);
...
@interface BBStateView()<UIGestureRecognizerDelegate> {
