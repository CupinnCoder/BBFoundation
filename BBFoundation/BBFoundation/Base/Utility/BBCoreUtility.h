...
#import "BBImageUtility.h"
#import "BBStringUtility.h"
#import "BBFileUtility.h"
#import "BBDeviceUtility.h"
#import "BBViewUtility.h"
...
@interface BBCoreUtility : NSObject

+ (instancetype)sharedUtility;



@property (nonatomic, strong) BBImageUtility       *imageUtility;

@property (nonatomic, strong) BBStringUtility      *stringUtility;

@property (nonatomic, strong) BBFileUtility        *fileUtility;

@property (nonatomic, strong) BBDeviceUtility      *deviceUtility;

@property (nonatomic, strong) BBViewUtility        *viewUtility;

@property (nonatomic, strong) BBSecurityUtility    *securityUtility;

@property (nonatomic, strong) BBUserDefaultUtility *dataUtility;
