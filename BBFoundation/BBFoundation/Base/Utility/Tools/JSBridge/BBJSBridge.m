...
@interface BBJSBridge ()<UIWebViewDelegate>
...
{
    BBJSBridge* bridge = [[[self class] alloc] init];
...
- (void)webViewDidFinishLoad:(UIWebView *)webView {
    ...
    if (![[webView stringByEvaluatingJavaScriptFromString:[NSString stringWithFormat:@"typeof window.%@ == 'object'", kBridgeName]] isEqualToString:@"true"]) {
        ...
        NSString *filePath = [bundle pathForResource:@"BBJSBridge" ofType:@"js"];
