...
{
    return currentOffsetX > previousOffsetX ? kBBScrollDirectionRight   :
    currentOffsetX < previousOffsetX ? kBBScrollDirectionLeft :
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView {
    BBLog(@"contentOffset.x = %f",scrollView.contentOffset.x);
