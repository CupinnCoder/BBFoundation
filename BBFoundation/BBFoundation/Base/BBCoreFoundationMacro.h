 ...
 *******************************************************************************
 Example:
 BBSYNTH_DUMMY_CLASS(NSString_BBAdd)
 */
#ifndef BBSYNTH_DUMMY_CLASS
#define BBSYNTH_DUMMY_CLASS(_name_) \
@interface BBSYNTH_DUMMY_CLASS_ ## _name_ : NSObject @end \
@implementation BBSYNTH_DUMMY_CLASS_ ## _name_ @end
#endif
