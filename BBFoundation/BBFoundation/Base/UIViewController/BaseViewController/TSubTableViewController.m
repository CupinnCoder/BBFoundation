...
@property (nonatomic ,strong ,readwrite) BBTableViewDataSource *dataSource;
...
- (void)loadView {
    ...
    if (_useASKit) {
        ...
        _asTableView.backgroundColor = BBSTYLEVAR(viewBackgroundColor);
        ...
        if (!_tableView) {
            ...
            _tableView.backgroundColor = BBSTYLEVAR(viewBackgroundColor);
